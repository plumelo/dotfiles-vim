...
set mouse=a " Mouse activated in Normal and Visual Mode
set ttyfast " Faster redraw
set noshowmode " Don't display the current mode
set cursorline " Highligt the cursor line
set scrolloff=5 " Always keep 10 lines after or before when scrolling
...
" Usefull shortcuts to speed thinks
nnoremap ; :
...
call CreateShortcut("C-f", ":%s/", "in", "noTrailingIInInsert")
