...
" ansible project
nmap ,d :<C-u>CtrlP defaults/<CR>
nmap ,ta :<C-u>CtrlP tasks/<CR>
nmap ,te :<C-u>CtrlP test/<CR>
nmap ,tm :<C-u>CtrlP templates/<CR>
nmap ,v :<C-u>CtrlP vars/<CR>
nmap ,m :<C-u>CtrlP meta/<CR>
nmap ,h :<C-u>CtrlP handlers/<CR>
